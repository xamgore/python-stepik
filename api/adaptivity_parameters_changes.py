...
class ListOfAdaptivityParametersChanges:
    ...
    def get(self, id: int) -> AdaptivityParametersChange:
        return AdaptivityParametersChange(self._stepik, self._stepik._fetch_object(AdaptivityParametersChange, id))


    def get_all(self, ids: List[int], keep_order=False) -> Iterable[AdaptivityParametersChange]:
